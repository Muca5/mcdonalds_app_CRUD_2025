...
fun RegisterScreen(
    ...
    // Cores do tema
    val primaryColor = Color(0xFFff0000) // Nova cor verde do primeiro código
    val primaryDarkColor = Color(0xFFf2f2f2)
    val textColor = Color.Red
    val cardBackground = Color(0xFFdcdcdc) // Fundo escuro como no primeiro código
    val textColorDark = Color.Red // Texto branco como no primeiro código
    val labelColor = Color.Red // Cor dos labels como no primeiro código

    // Gradiente de fundo
    val gradient = Brush.verticalGradient(
        colors = listOf(Color(0xFFff0000), Color(0xFFff0000)) // Fundo escuro sólido
    )
    ...
    Box(
        ...
        Card(
            ...
            Column(
                ...
                Image(
                    painter = painterResource(id = R.drawable.logomc),
